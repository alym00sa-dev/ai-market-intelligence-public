...
const DATA_SOURCES = [
  { label: "Hiring Signals", available: true },
]
    ...
    <nav className="sticky top-0 z-50 bg-[#0a0a0f]/95 backdrop-blur-sm text-white px-4 sm:px-6 h-14 flex items-center justify-between border-b border-white/[0.06]">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={ref}>
          ...
          {open && (
            <div className="absolute right-0 mt-1.5 w-48 bg-gray-900 rounded-lg shadow-xl border border-gray-700 py-1 z-50">
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full shrink-0 ${
                      source.available ? "bg-green-400" : "bg-gray-700"
                    }`}
                  />
                  {source.label}
                  {!source.available && (
